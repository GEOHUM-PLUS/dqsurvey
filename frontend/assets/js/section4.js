...
const endpoint = isEdit
  ? `http://localhost:8020/section4/section4/${section4Id}`
  : `http://localhost:8020/section4/section4`;
...
sessionStorage.setItem("step4", "0");
  ...
  async function refillSection4FromDB(section4Id, section1Id, section2Id, section3Id) {
    try {
      const url = `http://localhost:8020/section4/bySection1And2And3/${section4Id}/${section1Id}/${section2Id}/${section3Id}`;
