...
// document.getElementById('Initial-info')?.addEventListener('click', async function (e) {

//   e.preventDefault();

//   // required fields validation
//   const datasetTitle = document.getElementById('datasetTitle').value.trim();
//   const dataProcessingLevel = document.getElementById('dataprocessinglevel').value.trim();
//   const dataType = document.getElementById('dataType').value.trim();
//   const evaluationType = document.getElementById('evaluationType').value.trim();

//   if (!datasetTitle || !dataProcessingLevel || !dataType || !evaluationType) {
//     alert("Please fill all required fields (*) before proceeding.");
//     return;
//   }
...
//   // SEND TO BACKEND — WAIT FOR ID
//   let response;
//   try {
//     response = await fetch('http://localhost:8020/section1', {
//       method: 'POST',
//       headers: { 'Content-Type': 'application/json' },
//       body: JSON.stringify(data)
//     }).then(r => r.json());
...
//   // Build section1Data for local storage
//   const section1Data = {
//     basic: {
//       id: response.id,  // ← FIXED (NOW INCLUDING DB ID)
//       datasetTitle,
//       evaluatorName: data.evaluatorName,
//       evaluatorOrg: data.affiliation,
//       dataProcessingLevel,
//       dataType,
//       dataTypeOther: data.dataTypeOther,
//       evaluationType
//     },
//     useCase:
//       evaluationType === "use-case-adequacy"
...
//           optimumDataCollection: data.optimumDataCollection,
